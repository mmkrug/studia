...
public class zad1_amplituda_c extends JPanel{
    ...
    static double max_value = 70;
    static double min_value = -70;
    ...
    public static void main(String[] args){
        ...
        JFrame f = new JFrame("Zad 1 c. Modulacja amplitudy");
        f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        zad1_amplituda_c graphics = new zad1_amplituda_c();
        f.add(graphics);
