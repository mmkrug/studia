...
public class zad2_amplituda_b_liniowa extends JPanel{
    ...
    public static void main(String[] args){
        JFrame f = new JFrame("Zad 2 b. Widmo modulacji amplitudy");
        f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);


        zad2_amplituda_b_liniowa graphics = new zad2_amplituda_b_liniowa();
        f.add(graphics);
