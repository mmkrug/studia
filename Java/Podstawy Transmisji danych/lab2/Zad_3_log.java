...
public class Zad_3_log extends JPanel{
    ...
    static double max_value = 38;//Double.MIN_VALUE;//2;
    static double min_value = -6;//Double.MAX_VALUE;//max_value-max_value-max_value;
    ...
    public static void main(String[] args){
        JFrame f = new JFrame("Zad 3. Skala logarytmiczna");
        f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);


        Zad_3_log graphics = new Zad_3_log();
        f.add(graphics);
