...
public class fsk_wykres extends JPanel{
    ...
    static double max_value = 3;
    static double min_value = -3;
...
//            if(bity[iteracja_bitow]==0){
//                suma += Math.sin(2*Math.PI*f_n1*x);
//                wartosci_Y[i] = suma;
//            }else{
//                suma += Math.sin(2*Math.PI*f_n2*x);
//                wartosci_Y[i] = suma;
//            }
    ...
    public static void main(String[] args){
        ...
        fsk_wykres graphics = new fsk_wykres();
        f.add(graphics);
