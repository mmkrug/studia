...
public class zad1_amplituda_b extends JPanel{
    ...
    static double max_value = 7;
    static double min_value = -7;
    ...
    public static void main(String[] args){
        ...
        JFrame f = new JFrame("Zad 1 b. Modulacja amplitudy");
        f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        zad1_amplituda_b graphics = new zad1_amplituda_b();
        f.add(graphics);
