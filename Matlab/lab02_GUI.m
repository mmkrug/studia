function varargout = lab02_GUI(varargin)
% LAB02_GUI MATLAB code for lab02_GUI.fig
%      LAB02_GUI, by itself, creates a new LAB02_GUI or raises the existing
%      singleton*.
%
%      H = LAB02_GUI returns the handle to a new LAB02_GUI or the handle to
%      the existing singleton*.
%
%      LAB02_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in LAB02_GUI.M with the given input arguments.
%
%      LAB02_GUI('Property','Value',...) creates a new LAB02_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before lab02_GUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to lab02_GUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help lab02_GUI
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @lab02_GUI_OpeningFcn, ...
                   'gui_OutputFcn',  @lab02_GUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before lab02_GUI is made visible.
function lab02_GUI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to lab02_GUI (see VARARGIN)

% Choose default command line output for lab02_GUI
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes lab02_GUI wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = lab02_GUI_OutputFcn(hObject, eventdata, handles) 
