<?php
    ...
    // polaczona z baza danych
        ...
        if((isset($_SESSION['wszystko_OK'])) && ($_SESSION['wszystko_OK']==true)){
            ...
            $sql= "INSERT INTO
                    uzytkownicy(id,login,haslo,uprawnienia,imie,nazwisko)
                    VALUES (NULL,'$login', '$haslo', 0, '$imie', '$nazwisko')";
             
            if($polaczenie->query($sql)){
                // udane logowanie.
                $_SESSION['zarejestrowany_imie'] = $imie;
                $_SESSION['zarejestrowany_nazwisko'] = $nazwisko;
            ...
            echo '
                    <tr>
                        <td>&nbsp;</td>
                        <td align="center"><input type ="submit" name="zarejestruj" value="Zarejestruj"></td>
                    </tr>
                </table>
            </form>
            ';
