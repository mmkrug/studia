...
public class zad2_widmo_psk extends JPanel{
...
;
    ...
    public void paintComponent(Graphics g){
        ...
        for(int i=0;i<ilosc_probek;i++){
            ...
            logarytmiczna[i] = Math.pow(10,(double)i/(ilosc_probek/4));
            ...
            if(bity[iteracja_bitow]==0){
                wartosci_Y[i] = Math.sin(2*Math.PI*f_n*x);
            }else{
                wartosci_Y[i] = Math.sin(2*Math.PI*f_n*x+Math.PI);
            }
            //###################### FUNKCJA #####################
    ...
    public static void main(String[] args){
        JFrame f = new JFrame("Zad 2. Widmo PSK");
        f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);


        zad2_widmo_psk graphics = new zad2_widmo_psk();
        f.add(graphics);
