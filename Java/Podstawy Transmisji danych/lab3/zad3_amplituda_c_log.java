...
public class zad3_amplituda_c_log extends JPanel{
    ...
    public static void main(String[] args){
        JFrame f = new JFrame("Zad 3 c. Widmo modulacji amplitudy log");
        f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);


        zad3_amplituda_c_log graphics = new zad3_amplituda_c_log();
        f.add(graphics);
