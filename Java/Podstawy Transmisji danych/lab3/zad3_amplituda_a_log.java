...
public class zad3_amplituda_a_log extends JPanel{
    ...
    public static void main(String[] args){
        JFrame f = new JFrame("Zad 3 a. Widmo modulacji amplitudy log");
        f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);


        zad3_amplituda_a_log graphics = new zad3_amplituda_a_log();
        f.add(graphics);
