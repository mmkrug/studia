...
public class Zad_2_a_log extends JPanel{
    ...
    static double max_value = 24;//Double.MIN_VALUE;//2;
    static double min_value = -24;//Double.MAX_VALUE;//max_value-max_value-max_value;
    ...
    public static void main(String[] args){
        JFrame f = new JFrame("Zad 2 a. Skala logarytmiczna");
        f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);


        Zad_2_a_log graphics = new Zad_2_a_log();
        f.add(graphics);
